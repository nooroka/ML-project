...
listnames = sorted(listname)
#aprint(dictall)
print(listnames[19895])#чтобы гомологичные были в одном месте
print(listnames[19896])
print(listnames[24154])
print(listnames[24155])
train,test,validate, no = np.split(listname,[19896,24155,28417]) #разбиение примерно!
#print(list(validate))
train2 = []
test2 = []
validate2 = []
